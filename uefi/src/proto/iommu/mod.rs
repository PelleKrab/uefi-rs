...
use crate::proto::iommu::iommu::Iommu;

pub mod iommu;

/// A smart pointer for DMA buffers that handles proper lifetime management
#[must_use]
#[derive(Debug)]
...
impl<'a> DmaBuffer<'a> {
    ...
    pub unsafe fn from_raw(ptr: *mut c_void, pages: usize, iommu: &'a Iommu) -> Self {
...
/// A smart pointer for IOMMU mappings that handles proper lifetime management
#[must_use]
#[derive(Debug)]
...
impl<'a> Mapping<'a> {
    ...
    pub unsafe fn from_raw(ptr: *mut c_void, iommu: &'a Iommu) -> Self {
        Self { ptr, iommu }
    }
